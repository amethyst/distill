...
pub mod asset_change_event {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_path_update_event<'b>(&mut self, value: crate::data_capnp::path_update_event::Reader<'b>) -> ::capnp::Result<()> {
    ...
    #[inline]
    pub fn set_path_remove_event<'b>(&mut self, value: crate::data_capnp::path_remove_event::Reader<'b>) -> ::capnp::Result<()> {
